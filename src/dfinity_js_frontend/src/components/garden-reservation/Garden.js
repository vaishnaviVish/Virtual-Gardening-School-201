...
import { deleteGarden } from "../../utils/garden";

const Garden = ({ garden, makeReservation, endReservation, deleteGarden }) => {
  const {
    id,
    name,
    imageUrl,
...
Garden.propTypes = {
  garden: PropTypes.instanceOf(Object).isRequired,
  makeReservation: PropTypes.func.isRequired,
  endReservation: PropTypes.func.isRequired,
  deleteGarden: PropTypes.func.isRequired,
};
