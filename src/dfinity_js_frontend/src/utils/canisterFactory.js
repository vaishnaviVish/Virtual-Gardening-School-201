...
import { idlFactory as gardenIDL } from "../../../declarations/dfinity_js_backend/dfinity_js_backend.did.js";
import { idlFactory as ledgerIDL } from "../../../declarations/ledger_canister/ledger_canister.did.js";

const GARDEN_CANISTER_ID = "bd3sg-teaaa-aaaaa-qaaba-cai";
const LEDGER_CANISTER_ID = "ryjl3-tyaaa-aaaaa-aaaba-cai";
const HOST = "http://localhost:8080";

export async function getGardenCanister() {
  return await getCanister(GARDEN_CANISTER_ID, gardenIDL);
}
